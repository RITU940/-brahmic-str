...
% ---- Rung Bbpe (stock-BPE ablation) WRR, % — 5/9 observed, 4 running ----
...
% TODO(bbpe): gujarati (training), bengali, devanagari, gurmukhi
% NB observed pivot/BPE WRR ratios so far: 3.9, 1.9, 1.16, 2.3, 1.7 — direction 5/5 for
% the pivot but magnitude varies; final abstract/intro wording must use the 9/9 range.
