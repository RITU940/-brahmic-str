...
(Sec.~\ref{sec:analysis}). The archive is anonymized for review: the commit hashes that
establish filing order would identify us, so the supplement ships the filed documents
themselves under SHA-256, and the hashes become verifiable at camera-ready.
