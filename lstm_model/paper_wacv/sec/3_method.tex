...
settable by the author. The supplement therefore ships the filed documents themselves under
SHA-256, which establishes that they are unaltered --- not when they were written. At review time,
filing order rests on our attestation; publishing the repository at camera-ready adds provenance
but not proof, and we do not offer it as proof. A campaign starting today should anchor each
filing, at the moment it is filed, in a timestamp no author controls --- an anonymized preregistration
or a blockchain-anchored hash. Ours predates that decision, and we ask the reader to discount the
prospectivity claim accordingly rather than to assume it.
